...
import pygame
from ui.widgets.base import Widget, Clickable, Hoverable
...
class Button(Widget, Clickable, Hoverable):
    ...
    def __init__(self, text: str, x: int = 0, y: int = 0, width: int = 150, height: int = 40,

                    ...
                    events.append(
                        {
                            ...
                            "data": {"position": event.pos, "button": event.button},
                        }
                    )

                elif event.type == MOUSEMOTION:
                    self.last_mouse_pos = event.pos
                    events.append({"type": InputEvent.HOVER, "data": {"position": event.pos}})

                # Window events
                elif event.type == VIDEORESIZE:
                    events.append(
                        {"type": InputEvent.RESIZE, "data": {"width": event.w, "height": event.h}}
                    )

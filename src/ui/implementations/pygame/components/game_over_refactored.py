...
class GameOver:
    ...
    def _build_ui(self):
        ...
        # Scores
        black_label = Label(f"{self.black_player_name}: {self.black_score}", 
                           x=0, y=0, font_size=42, color=(200, 220, 210))
        white_label = Label(f"{self.white_player_name}: {self.white_score}", 
                           x=0, y=0, font_size=42, color=(200, 220, 210))
        ...
        menu_btn = Button("Menu", x=0, y=0, width=200, height=50,
                         on_click=lambda: setattr(self, 'result', 'menu'),
                         color=(0, 80, 60), text_color=(230, 240, 235))
        exit_btn = Button("Exit", x=0, y=0, width=200, height=50,

...
class EnhancedOpeningBook(OpeningBook):
    ...
    def select_best_move(
        ...
        if mode == SelectionMode.BEST_SCORE:
            ...
            sorted_by_variety = sorted(filtered_moves, key=lambda e: e.count_continuations, reverse=True)
            ...
            aggressive_moves = [e for e in filtered_moves if e.advantage_symbol in ["w++", "w+", "b++", "b+"]]
            if aggressive_moves:

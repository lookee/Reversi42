...
class AlphaBetaSearchComplete(SearchAlgorithm):
    ...
    def __init__(self, evaluator: CompositeEvaluator, orderer: CompositeOrderer,
                 enable_null_move: bool = True, enable_futility: bool = True,
                 enable_lmr: bool = True, enable_multi_cut: bool = True):
        """
    ...
    def alphabeta(self, game, depth: int, alpha: int, beta: int, allow_null_move: bool = True) -> int:
        """
        ...
        for move_index, move in enumerate(ordered_moves):
            ...
            if alpha >= beta:
                ...
                # MULTI-CUT PRUNING
                if self.multi_cut and self.multi_cut.should_multi_cut(cutoff_count, move_index, depth):

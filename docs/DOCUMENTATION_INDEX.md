...
### Getting Started
- [**Getting Started Guide**](user-guide/getting-started.md) - Install and play your first game
- [**Game Rules**](user-guide/game-rules.md) - Complete Reversi/Othello rules
...
Essential project files and policies.
...
### Study Tools
- [WOF Study Support](https://www.worldothello.org/about/study-othello/study-support)
- Recommended engines and analysis tools

...
from webgui.server.reversi42_server import (
    GameSession,
    active_connections,
    app,
...
class TestRESTEndpoints:
    ...
    def test_get_stats(self):
        ...
        from webgui.server.reversi42_server import get_stats
    ...
    def test_get_version(self):
        ...
        from webgui.server.reversi42_server import get_version
...
class TestWebSocketMessages:
    ...
    async def test_init_message(self, mock_websocket):
        ...
        data = {"type": "init", "ai_player": "DIVZERO.EXE"}
    ...
    async def test_human_move_invalid(self, mock_websocket, test_session):
        ...
        data = {"type": "human_move", "move": "A1"}  # Invalid
    ...
    async def test_set_players_both_ai(self, mock_websocket, test_session):
        ...
        data = {"type": "set_players", "white": "DIVZERO.EXE", "black": "DIVZERO.EXE"}
    ...
    async def test_set_players_both_human(self, mock_websocket, test_session):
        ...
        data = {"type": "set_players", "white": "Human", "black": "Human"}
    ...
    async def test_set_players_mixed(self, mock_websocket, test_session):
        ...
        data = {"type": "set_players", "white": "Human", "black": "DIVZERO.EXE"}
    ...
    async def test_load_history_valid(self, mock_websocket, test_session):
        ...
        data = {"type": "load_history", "history": "C4e3"}
    ...
    async def test_load_history_invalid(self, mock_websocket, test_session):
        ...
        data = {"type": "load_history", "history": "A1Z9"}  # Invalid moves
    ...
    async def test_load_history_empty(self, mock_websocket, test_session):
        ...
        data = {"type": "load_history", "history": ""}

...
class TestObserverNotifications:
    ...
    async def test_on_search_start(self, observer_with_websocket):
        ...
        observer.on_search_start(
            depth=8, player_name="TestPlayer", game=MagicMock(), mode="sequential"
        )
    ...
    async def test_on_iteration_start(self, observer_with_websocket):
        ...
        observer.on_iteration_start(
            current_depth=5, target_depth=8, use_aspiration=True, alpha=-100, beta=100
        )
    ...
    async def test_on_move_evaluated_not_best(self, observer_with_websocket):
        ...
        observer.on_move_evaluated(
            move=move, value=30, is_best=False, nodes=500, pruning=100, elapsed_time=50.0
        )
    ...
    async def test_on_iteration_complete_success(self, observer_with_websocket):
        ...
        observer.on_iteration_complete(
            depth=5, best_move=move, value=50, iteration_time=100.0, aspiration_success=True
        )
    ...
    async def test_on_iteration_complete_failure(self, observer_with_websocket):
        ...
        observer.on_iteration_complete(
            depth=5, best_move=move, value=50, iteration_time=100.0, aspiration_success=False
        )
    ...
    async def test_on_search_complete(self, observer_with_websocket):
        ...
        statistics = {"nodes_searched": 10000, "nodes_pruned": 2000, "depth_reached": 8}
...
class TestStatisticsFormatting:
    ...
    def test_calculate_tt_rate(self):
        ...
        stats = {"tt_hits": 500, "nodes_searched": 1000}
    ...
    def test_calculate_tt_rate_zero_nodes(self):
        ...
        stats = {"tt_hits": 0, "nodes_searched": 0}
...
class TestMessageSending:
    ...
    async def test_send_ai_log(self, observer_with_websocket):
        ...
        observer._send_ai_log(log_type="test_log", message="Test message", data={"key": "value"})
...
class TestEdgeCases:
    ...
    def test_move_evaluation_with_none_move(self):
        ...
        # Should not crash
        observer.on_move_evaluated(
            move=None, value=0, is_best=False, nodes=100, pruning=20, elapsed_time=10.0
        )
    ...
    def test_iteration_complete_with_none_move(self):
        ...
        observer.on_iteration_complete(
            depth=5, best_move=None, value=0, iteration_time=100.0, aspiration_success=True
        )
    ...
    def test_large_statistics_values(self):
        ...
        stats = {"nodes_searched": 1000000000, "nodes_pruned": 500000000, "depth": 20}  # 1 billion
    ...
    def test_zero_time_elapsed(self):
        ...
        observer.on_iteration_complete(
            depth=1, best_move=Move(3, 4), value=10, iteration_time=0.0, aspiration_success=True
        )
    ...
    def test_negative_statistics(self):
        ...
        observer.on_move_evaluated(
            move=Move(3, 4), value=-100, is_best=True, nodes=1000, pruning=200, elapsed_time=50.0
        )
...
class TestIntegrationScenarios:
    ...
    def test_complete_search_lifecycle(self):
        ...
        # Search start
        observer.on_search_start(depth=6, player_name="TestAI", game=MagicMock(), mode="sequential")
        ...
        # Search complete
        stats = {"nodes_searched": 10000, "nodes_pruned": 2000, "depth": 6}
    ...
    def test_parallel_search_scenario(self):
        ...
        observer.on_search_start(
            depth=8, player_name="ParallelAI", game=MagicMock(), mode="parallel"
        )
    ...
    def test_search_with_aspiration_failures(self):
        ...
        observer.on_search_start(
            depth=8, player_name="AspirationAI", game=MagicMock(), mode="sequential"
        )

        # Mix of successes and failures
        for depth in range(1, 9):
            observer.on_iteration_start(
                current_depth=depth, target_depth=8, use_aspiration=True, alpha=-100, beta=100
            )
